                        ...
                        <div class="gmr-box-content gmr-single">
                            ...
                            <div class="entry-content entry-content-single" itemprop="text">
                                ...
                                <div class="wp-block-image"><figure class="aligncenter size-large">
                                    <a href="/watch-now"><img src="<?php echo $thumbnail; ?>" alt="<?php echo $title; ?>" title="<?php echo $title; ?>" style="width:100%;" /></a>
                                </figure></div>
                            ...
                            <div style="display:block;width:100%;position:relative;margin-bottom:20px;margin-top:5px;text-align:center;">
                                    <a href="<?php echo $finishLink; ?>" class="btn btn-danger" style="border-color: #af1820;padding: 0 15px;line-height: 36px !important;width: 330px !important;border-radius: 7px !important;TEXT-TRANSFORM: capitalize !important;background: #af1820 !important;font-size: 16px !important;">
...
<?php 
    $scrollDelay3 = ( !empty( $nilaiScroll ) ? $nilaiScroll : 4 );
?>
